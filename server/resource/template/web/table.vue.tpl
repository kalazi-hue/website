<template>
  <div>
    ...
    <el-table-column label="{{.FieldDesc}}" prop="{{.FieldJson}}" ></el-table-column> {{ end }}
    {{ end }}
    <el-table-column label="创建日期" >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button class="table-button" @click="update{{.StructName}}(scope.row)" size="small" type="primary" icon="el-icon-edit">编辑</el-button>
